...
[![npm](https://img.shields.io/npm/v/@taktikorg/commodi-laudantium.svg)](https://www.npmjs.com/package/@taktikorg/commodi-laudantium)
[![downloads](https://img.shields.io/npm/dt/@taktikorg/commodi-laudantium.svg)](https://www.npmjs.com/package/@taktikorg/commodi-laudantium)
[![types](https://img.shields.io/npm/types/@taktikorg/commodi-laudantium.svg)](https://www.npmjs.com/package/@taktikorg/commodi-laudantium)
[![licence](https://img.shields.io/github/license/mnasyrov/@taktikorg/commodi-laudantium.svg)](https://github.com/taktikorg/commodi-laudantium/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@taktikorg/commodi-laudantium/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@taktikorg/commodi-laudantium?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@taktikorg/commodi-laudantium**][@taktikorg/commodi-laudantium/docs]             | Core elements, state and effect management | [Docs][@taktikorg/commodi-laudantium/docs], [API][@taktikorg/commodi-laudantium/api]             |
| [**@taktikorg/commodi-laudantium-react**][@taktikorg/commodi-laudantium-react/docs] | Tooling for React.js                       | [Docs][@taktikorg/commodi-laudantium-react/docs], [API][@taktikorg/commodi-laudantium-react/api] |
...
```
npm install @taktikorg/commodi-laudantium @taktikorg/commodi-laudantium-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@taktikorg/commodi-laudantium';
...
import { useConst, useObservable, useQuery } from '@taktikorg/commodi-laudantium-react';
...
[@taktikorg/commodi-laudantium/docs]: packages/@taktikorg/commodi-laudantium/README.md
[@taktikorg/commodi-laudantium/api]: packages/@taktikorg/commodi-laudantium/docs/README.md
[@taktikorg/commodi-laudantium-react/docs]: packages/@taktikorg/commodi-laudantium-react/README.md
[@taktikorg/commodi-laudantium-react/api]: packages/@taktikorg/commodi-laudantium-react/docs/README.md
